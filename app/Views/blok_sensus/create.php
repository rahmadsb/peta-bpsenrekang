...
<div class="container-fluid">
  <h1>Tambah Blok Sensus</h1>
  <form id="form-tambah-blok-sensus" action="<?= base_url('blok-sensus/store') ?>" method="post">
    <div class="form-group">
      <label>Kode BS</label>
      <input type="text" name="kode_bs" class="form-control" required>
    </div>
    <div class="form-group">
      <label>Nama BS</label>
      <input type="text" name="nama_bs" class="form-control" required>
    </div>
    <div class="form-group">
      <label>Kode SLS</label>
      <input type="text" name="kode_sls" class="form-control">
    </div>
    <div class="form-group">
      <label>Nama SLS</label>
      <input type="text" name="nama_sls" class="form-control">
    </div>
    <div class="form-group">
