...
<div class="container-fluid mt-4">
  <div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Edit SLS</h3>
    </div>
    <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select id="provinsi" class="form-control select2" name="nama_provinsi">
                <option value="<?= esc($sls['nama_provinsi']) ?>" selected><?= esc($sls['nama_provinsi']) ?></option>
              </select>
              <input type="hidden" name="kode_prov" id="kode_prov" value="<?= esc($sls['kode_prov']) ?>">
            </div>
            <div class="form-group">
              <label for="kabupaten">Kabupaten</label>
              <select id="kabupaten" class="form-control select2" name="nama_kabupaten">
                <option value="<?= esc($sls['nama_kabupaten']) ?>" selected><?= esc($sls['nama_kabupaten']) ?></option>
              </select>
              <input type="hidden" name="kode_kabupaten" id="kode_kabupaten" value="<?= esc($sls['kode_kabupaten']) ?>">
            </div>
            <div class="form-group">
              <label for="kecamatan">Kecamatan</label>
              <select id="kecamatan" class="form-control select2" name="nama_kecamatan">
                <option value="<?= esc($sls['nama_kecamatan']) ?>" selected><?= esc($sls['nama_kecamatan']) ?></option>
              </select>
              ...
              <input type="hidden" name="kode_kecamatan" id="kode_kecamatan" value="<?= esc($sls['kode_kecamatan']) ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select id="desa" class="form-control select2" name="nama_desa">
                <option value="<?= esc($sls['nama_desa']) ?>" selected><?= esc($sls['nama_desa']) ?></option>
              </select>
              ...
              <input type="hidden" name="kode_desa" id="kode_desa" value="<?= esc($sls['kode_desa']) ?>">
            </div>
            <div class="form-group">
              <label for="kode_sls">Kode SLS</label>
              <input type="text" name="kode_sls" id="kode_sls" class="form-control" value="<?= esc($sls['kode_sls']) ?>" required>
            </div>
            <div class="form-group">
              <label for="nama_sls">Nama SLS</label>
              <input type="text" name="nama_sls" id="nama_sls" class="form-control" value="<?= esc($sls['nama_sls']) ?>" required>
            </div>
          </div>
        </div>
        <div class="row">
