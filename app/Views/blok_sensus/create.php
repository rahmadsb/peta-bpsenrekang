...
<div class="container-fluid mt-4">
  <div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Tambah Blok Sensus</h3>
    </div>
    <div class="card-body">
      <form id="form-tambah-blok-sensus" action="<?= base_url('blok-sensus/store') ?>" method="post">
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="kode_bs" id="kode_bs" class="form-control" required>
            </div>
            <div class="form-group">
              <label for="nama_bs">Nama BS</label>
              <input type="text" name="nama_bs" id="nama_bs" class="form-control" required>
            </div>
          </div>
        </div>
        <div class="row">
...
<script>
  $(function() {
    ...
    $('#form-tambah-blok-sensus').on('submit', function(e) {
      e.preventDefault();

      // Validasi field yang diperlukan
      if (!$('#kode_bs').val() || !$('#nama_bs').val()) {
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: 'Kode BS dan Nama BS harus diisi!',
