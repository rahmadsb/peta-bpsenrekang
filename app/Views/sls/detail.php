...
<div class="container-fluid">
  <h1><?= $title ?></h1>
  <div class="mb-3">
    <strong>Kode SLS:</strong> <?= esc($sls['kode_sls']) ?><br>
    <strong>Nama SLS:</strong> <?= esc($sls['nama_sls']) ?><br>
    <strong>Nama Desa:</strong> <?= esc($sls['nama_desa']) ?><br>
    <strong>Kecamatan:</strong> <?= esc($sls['nama_kecamatan']) ?><br>
    <strong>Kabupaten:</strong> <?= esc($sls['nama_kabupaten']) ?><br>
    <strong>Provinsi:</strong> <?= esc($sls['nama_provinsi']) ?><br>
  </div>
  <h4>Daftar Kegiatan yang Melibatkan SLS Ini</h4>
