...
<script>
  $(function() {
    ...
    var selectedBlokSensus = <?php echo json_encode($selectedBlokSensus ?? []); ?>;
    var selectedSls = <?php echo json_encode($selectedSls ?? []); ?>;
    var selectedDesa = <?php echo json_encode($selectedDesa ?? []); ?>;
