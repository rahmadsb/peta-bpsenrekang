...
<div class="container-fluid">
  <h1><?= $title ?></h1>
  <div class="mb-3">
    <strong>Kode Desa:</strong> <?= esc($desa['kode_desa']) ?><br>
    <strong>Nama Desa:</strong> <?= esc($desa['nama_desa']) ?><br>
    <strong>Kecamatan:</strong> <?= esc($desa['nama_kecamatan']) ?><br>
    <strong>Kabupaten:</strong> <?= esc($desa['nama_kabupaten']) ?><br>
    <strong>Provinsi:</strong> <?= esc($desa['nama_provinsi']) ?><br>
  </div>
  <h4>Daftar Kegiatan yang Melibatkan Desa Ini</h4>
