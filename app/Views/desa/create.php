...
<div class="container-fluid mt-4">
  <div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Tambah Desa/Kelurahan</h3>
    </div>
    <div class="card-body">
      <form id="form-tambah-desa" action="<?= base_url('desa/store') ?>" method="post">
        <div class="row">
          <div class="col-md-6">
...
<script>
  $(function() {
    ...
    $('#form-tambah-desa').on('submit', function(e) {
      e.preventDefault();

      // Validasi field yang diperlukan
      if (!$('#kode_desa').val() || !$('#nama_desa').val()) {
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: 'Kode Desa dan Nama Desa harus diisi!',
